...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      {/* Date */}
      <span className="text-sm font-semibold uppercase tracking-widest text-white bg-linear-to-br from-pink to-lavendar shadow-md rounded-full px-8 py-2 mt-8 mb-12">
        {dateLabel}
      </span>

      {/* Song Image */}
      <div className="relative mb-8">
        <div className="absolute -inset-4 bg-linear-to-br from-pink via-lavendar to-blue rounded-full blur-2xl opacity-100" />
        <img
          src={song.image}
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="font-medium text-sm bg-lavendar shadow-md text-white rounded-full px-6 py-1.5 my-4 hover:opacity-90 transition-opacity"
      >
